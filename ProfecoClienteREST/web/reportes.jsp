<%-- 
    Document   : reportes
    Created on : 18/05/2022, 10:29:50 AM
    Author     : Juan Pablo
--%>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class=" myContainerAbs col-md-10  hidden-sm">
                            <form class="row" action="RegistrarMulta" method="post">
                                <div class="col" name="id"><h2>Computadora interactiva</h2></div>
                                <div class="col" name="mercado"><h2>Oxxo</h2></div>
                        
                                <div class="col"><button type="submit" class="btnReg btn-default form-control myButton">Reportar</button></div>
                            </form>
                        </div>
