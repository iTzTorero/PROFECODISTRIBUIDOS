 ...
 * USAGE:
 * <pre>
 *        ConsumidorRESTClient client = new ConsumidorRESTClient();
...
public class ConsumidorRESTClient {
    ...
    public void registrarReview(String id) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("review/{0}", new Object[]{id})).request().post(null);
    }
    ...
    public String login() throws ClientErrorException {
        return webTarget.path("login").request(javax.ws.rs.core.MediaType.APPLICATION_FORM_URLENCODED).post(null, String.class);
    }
