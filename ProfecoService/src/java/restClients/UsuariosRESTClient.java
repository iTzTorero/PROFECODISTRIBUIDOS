 ...
 * USAGE:
 * <pre>
 *        UsuariosRESTClient client = new UsuariosRESTClient();
 ...
 * @author Juan Pablo
 */
public class UsuariosRESTClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/AccesoDatosUsuario/webresources";
